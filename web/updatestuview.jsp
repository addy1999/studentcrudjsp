<%-- 
    Document   : updatestuview
    Created on : 30-Oct-2020, 4:58:31 PM
    Author     : adhil
--%>
...
<html>
    ...
    <body>
        ...
        <tr><td>${s.getRoll()}</td><td>${s.getName()}</td><td>${s.getSemester()}</td><td>${s.getCgpa()}</td><td><a href="updatestu.jsp?roll=${s.getRoll()}">Edit</a></td></tr>  
        </c:forEach>  
        </table>
